...
import co.edu.gestiontutoriasmongo.service.ReservaService;
...
public class ReservaController {
    ...
    public ResponseEntity<List<Reserva>> listarPorEstudiante(@PathVariable String estudianteId) {
        return ResponseEntity.ok(reservaService.listarPorEstudiante(estudianteId));
    }
    @GetMapping("/tutor/{tutorId}")
    public ResponseEntity<List<Reserva>> listarPorTutor(@PathVariable String tutorId) {
